...
export const BloomHud = ({ children, renderPriority = 1, bloomArgs = [] }) => {
...
function RenderHud({ defaultScene, defaultCamera, renderPriority = 1, bloomArgs = [] }: RenderHudProps) {
    ...
    const [bloom, final] = useMemo(() => {
      ...
      comp.addPass(new UnrealBloomPass(new THREE.Vector2(1024, 1024), .9, 1, .1))
